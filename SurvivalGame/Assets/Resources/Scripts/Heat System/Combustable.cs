...
public class Combustable : MonoBehaviour
{
    ...
    public float
        heatResistance =
            5; //On a scale of 1-10 how resistant is the object to heat? (1 = extermely non-resistant, 10 = extremely resistant)
    ...
    protected virtual void OnCollisionEnter(Collision collision)
    {
        ...
        if (impactedObject.GetComponent<Collider>() != null && collider != null)
        {
            bool overlapped = Physics.ComputePenetration(collider, transform.position, transform.rotation,
                impactedObject.GetComponent<Collider>(), objectPosition, objectRotation, out directionOut,
                out distanceOut);
